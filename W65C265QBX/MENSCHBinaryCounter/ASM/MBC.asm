...
; This is the Assembly Language code to makes the pins "outputs" to turn on and off the LEDs.

	ldx #$0000	; Load the X register with value $0000

	ldy #$0001	; Load the y register with a delay count of $0001

	sty $00f0	; Store the delay count at $00f0

	lda #$00	; Load the A register with $00 to set all P7x as outputs.

	sta $df27	; Make PD7 outputs.

	sta $df23	; Turn ON 8 LEDs for $81
