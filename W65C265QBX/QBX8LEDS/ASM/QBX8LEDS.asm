...
;This part is just checking the registers that are effected
	...
	sta BCR		; Set P0x, P1x and P2x as IO ports when BCR0 = 0

	sta PCS7	; All P7x pins are now outputs.
	sta PDD0	; Make P0x outputs
	sta PDD1	; Make P1x outputs
	sta PDD2	; Make P2x outputs

	ldx #$00
	nop
	lda #$aa
	sta PD7		; Turn ON alternating 8 LEDs
	
;	rep #$ef	; Clear X to 0 for return
