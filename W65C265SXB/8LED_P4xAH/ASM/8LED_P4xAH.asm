...
;; IO Ports 
  ...
  PD7:  			equ $DF23 ;; Port 3 Data Register
  PD6:  			equ $DF22 ;; Port 2 Data Register
  PD5:  			equ $DF21 ;; Port 1 Data Register
  PD4:  			equ $DF20 ;; Port 0 Data Register
...
;
;Example code to make a P47 Control and LED
	...
	START:
		...
		lda PDD4				; Load value of P4 Data Direction Register.  
		sta $3000
		and #$FF
		bit #%10000000	; $90 - Check if P47 is an output   - All segments with a '0' light up
		beq NOSETDDR		; Branch down to set Data Reg if P46 is an output
		ora #%10000000	; Set P46 HIGH or OUTPUT, do not change others.  	
		sta $3001
NOSETDDR:
		lda PD4
		sta $3010
;		AND #%01111111			; AND Acc ($8F) with current value of P4 Data reg.  Sets P47 LOW
		ora #%10000000			; OR Acc ($90) with current value of P4 Data reg.  Sets P47 HIGH
		sta $3011
		sta PD4
		rtl
