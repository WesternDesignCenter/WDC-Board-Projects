...
; Now we 
		lda #$00
		sta VIA_PCR     ; Make sure CB1 and CB2 are input Negative Active Edge
		sta $1000	
...
;		lda #$82		
;		sta VIA_ORB		; Display a '6'
;		inc $1000		; increment value in 1000 so we can see how many times button is pressed.
;						;Debounce is not great, might increase more than 1
;		lda	VIA_IRB     ; Clear IFR with a read of IRB
;		bra ReadPB		; Poll the pin again
